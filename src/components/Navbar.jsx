...
import DarkThemeSwitch from './NavbarHelper'
        ...
        >
          ...
          {/* <Menu
            ...
            <MenuItem onClick={handleMenuClose}>
                <Typography sx={{ textAlign: 'center' }}>Mini Projects</Typography>
            </MenuItem>
          </Menu> */}
          ...
          >
            {({ TransitionProps, placement }) => (
              ...
              {/* <Typography variant='h6' sx={{ textAlign: 'center' }}>Mini Projects</Typography> */}
          </MenuItem>
          ...
          <Box sx={{ display: { xs: 'flex', md: 'none' } }}>
            ...
            {/* <IconButton>
                <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }}>
                    ...
                    <FormControlLabel
                        control={<DarkThemeSwitch sx={{ m: 1 }} defaultChecked />}
                        label="MUI switch"
                    />
